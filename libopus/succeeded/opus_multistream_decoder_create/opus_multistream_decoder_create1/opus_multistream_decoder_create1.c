...
extern "C" int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    ...
    //GEN_SIZE
    int * sz__error = (int *) dyn_cstring_size[0];
    
    //FUNCTION_CALL
    opus_multistream_decoder_create(b_Fs ,b_channels ,b_streams ,b_coupled_streams ,str_mapping ,sz__error );
    //FREE
    if (rstr_mapping) {
        free(rstr_mapping);
        rstr_mapping = NULL;
...
// Compile command:
/* 
/home/futag/Futag-tests/futag-llvm/bin/clang++ -fsanitize=address,fuzzer -g -O0 -ferror-limit=1 -I/home/futag/Futag-tests/libopus/opus-1.3.1/.futag-build/ -I/home/futag/Futag-tests/libopus/opus-1.3.1/ -I/home/futag/Futag-tests/libopus/opus-1.3.1/include/ -I/home/futag/Futag-tests/libopus/opus-1.3.1/celt/ -I/home/futag/Futag-tests/libopus/opus-1.3.1/silk/ -I/home/futag/Futag-tests/libopus/opus-1.3.1/silk/float/ -I/home/futag/Futag-tests/libopus/opus-1.3.1/silk/fixed/ -DHAVE_CONFIG_H -I/home/futag/Futag-tests/libopus/opus-1.3.1/src/ /home/futag/Futag-tests/libopus/opus-1.3.1/futag-fuzz-drivers/succeeded/opus_multistream_decoder_create/opus_multistream_decoder_create1/opus_multistream_decoder_create1.c -o /home/futag/Futag-tests/libopus/opus-1.3.1/futag-fuzz-drivers/succeeded/opus_multistream_decoder_create/opus_multistream_decoder_create1/opus_multistream_decoder_create1.out -Wl,--start-group /home/futag/Futag-tests/libopus/opus-1.3.1/.futag-build/.libs/libopus.a /home/futag/Futag-tests/libopus/opus-1.3.1/.futag-install/lib/libopus.a -Wl,--end-group 
 */

// Error log:
/* 
clang-14: warning: treating 'c' input as 'c++' when in C++ mode, this behavior is deprecated [-Wdeprecated]
/home/futag/Futag-tests/libopus/opus-1.3.1/.futag-fuzz-drivers/opus_multistream_decoder_create/opus_multistream_decoder_create1/opus_multistream_decoder_create1.c:65:5: warning: ignoring return value of function declared with 'warn_unused_result' attribute [-Wunused-result]
    opus_multistream_decoder_create(b_Fs ,b_channels ,b_streams ,b_coupled_streams ,str_mapping ,sz__error );
    ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
1 warning generated.
