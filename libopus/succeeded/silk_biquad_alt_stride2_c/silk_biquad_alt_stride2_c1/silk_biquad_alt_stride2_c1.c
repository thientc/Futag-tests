...
int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    ...
    //FUNCTION_CALL
    silk_biquad_alt_stride2_c(p_q_b__in ,p_q_b__B_Q28 ,p_q_b__A_Q28 ,p_b__S ,p_b__out ,q_b__len );
    //FREE
    return 0;
}
// Compile database: 
