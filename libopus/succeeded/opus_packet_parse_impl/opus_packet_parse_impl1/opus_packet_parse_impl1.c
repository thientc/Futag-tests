...
int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    if (Fuzz_Size < 0*sizeof(wchar_t) + 0*sizeof(char) + 3 + 0 + sizeof(opus_int32) + sizeof(int) + 48 * sizeof(short) + sizeof(int) + sizeof(opus_int32)) return 0;
    size_t dyn_cstring_buffer = (size_t) ((Fuzz_Size + sizeof(char) - (0*sizeof(wchar_t) + 0*sizeof(char) + 3 + 0 + sizeof(opus_int32) + sizeof(int) + 48 * sizeof(short) + sizeof(int) + sizeof(opus_int32) )));
    ...
    //GEN_BUILTIN
    int b_self_delimited;
    memcpy(&b_self_delimited, futag_pos, sizeof(int));
    ...
    //GEN_BUILTIN
    opus_int32 b__packet_offset;
    memcpy(&b__packet_offset, futag_pos, sizeof(opus_int32));
    futag_pos += sizeof(opus_int32);
    //GEN_POINTER
    opus_int32 * p_b__packet_offset = & b__packet_offset;
    
    //FUNCTION_CALL
    opus_packet_parse_impl(str_data ,b_len ,b_self_delimited ,str_out_toc ,p_str__frames ,a_size ,p_b__payload_offset ,p_b__packet_offset );
    //FREE
    if (rstr_data) {
        free(rstr_data);
        rstr_data = NULL;
...
// Compile command:
/* 
/home/futag/Futag-tests/futag-llvm/bin/clang -fsanitize=address,fuzzer -g -O0 -ferror-limit=1 -I/home/futag/Futag-tests/libopus/opus-1.3.1/.futag-build/ -I/home/futag/Futag-tests/libopus/opus-1.3.1/ -I/home/futag/Futag-tests/libopus/opus-1.3.1/include/ -I/home/futag/Futag-tests/libopus/opus-1.3.1/celt/ -I/home/futag/Futag-tests/libopus/opus-1.3.1/silk/ -I/home/futag/Futag-tests/libopus/opus-1.3.1/silk/float/ -I/home/futag/Futag-tests/libopus/opus-1.3.1/silk/fixed/ -DHAVE_CONFIG_H -I/home/futag/Futag-tests/libopus/opus-1.3.1/src/ /home/futag/Futag-tests/libopus/opus-1.3.1/futag-fuzz-drivers/succeeded/opus_packet_parse_impl/opus_packet_parse_impl1/opus_packet_parse_impl1.c -o /home/futag/Futag-tests/libopus/opus-1.3.1/futag-fuzz-drivers/succeeded/opus_packet_parse_impl/opus_packet_parse_impl1/opus_packet_parse_impl1.out -Wl,--start-group /home/futag/Futag-tests/libopus/opus-1.3.1/.futag-build/.libs/libopus.a /home/futag/Futag-tests/libopus/opus-1.3.1/.futag-install/lib/libopus.a -Wl,--end-group 
 */

// Error log:
/* 
/home/futag/Futag-tests/libopus/opus-1.3.1/.futag-fuzz-drivers/opus_packet_parse_impl/opus_packet_parse_impl1/opus_packet_parse_impl1.c:78:27: warning: initializing 'const unsigned char *' with an expression of type 'char *' converts between pointers to integer types where one is of the unique plain 'char' type and the other is not [-Wpointer-sign]
    const unsigned char * str__frames = rstr__frames;
                          ^             ~~~~~~~~~~~~
/home/futag/Futag-tests/libopus/opus-1.3.1/.futag-fuzz-drivers/opus_packet_parse_impl/opus_packet_parse_impl1/opus_packet_parse_impl1.c:102:63: warning: passing 'char *' to parameter of type 'unsigned char *' converts between pointers to integer types where one is of the unique plain 'char' type and the other is not [-Wpointer-sign]
    opus_packet_parse_impl(str_data ,b_len ,b_self_delimited ,str_out_toc ,p_str__frames ,a_size ,p_b__payload_offset ,p_b__packet_offset );
                                                              ^~~~~~~~~~~
/home/futag/Futag-tests/libopus/opus-1.3.1/src/opus_private.h:166:42: note: passing argument to parameter 'out_toc' here
