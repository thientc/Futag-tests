...
extern "C" int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    ...
    //GEN_BUILTIN
    int b_rows;
    memcpy(&b_rows, futag_pos, sizeof(int));
    futag_pos += sizeof(int);
    
    //GEN_BUILTIN
    int b_cols;
    memcpy(&b_cols, futag_pos, sizeof(int));
    futag_pos += sizeof(int);
    
    //FUNCTION_CALL
    mapping_matrix_get_size(b_rows ,b_cols );
    //FREE
    return 0;
}
// Compile database: 
