...
int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    ...
    //GEN_BUILTIN
    opus_int16 b__a;
    memcpy(&b__a, futag_pos, sizeof(opus_int16));
    futag_pos += sizeof(opus_int16);
    //GEN_POINTER
    opus_int16 * p_b__a = & b__a;
    ...
    //FUNCTION_CALL
    silk_insertion_sort_increasing_all_values_int16(p_b__a ,q_b__L );
    //FREE
    return 0;
}
// Compile database: 
