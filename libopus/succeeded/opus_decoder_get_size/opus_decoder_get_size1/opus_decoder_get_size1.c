...
int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    ...
    //FUNCTION_CALL
    opus_decoder_get_size(b_channels );
    //FREE
    return 0;
}
// Compile database: 
