...
extern "C" int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    ...
    struct json_object * FutagRefVarCWF = json_object_new_string(str_s0 );
    //FREE
    if (rstr_s0) {
        free(rstr_s0);
        rstr_s0 = NULL;
    ...
    struct json_object * FutagRefVarrUS = json_object_new_string(str_s1 );
    //FREE
    if (rstr_s1) {
        free(rstr_s1);
        rstr_s1 = NULL;
    ...
    struct json_object * FutagRefVarcmL = json_object_new_int64(b_i2 );
    //GEN_BUILTIN
    int64_t b_i3;
    memcpy(&b_i3, futag_pos, sizeof(int64_t));
    futag_pos += sizeof(int64_t);
    
    struct json_object * FutagRefVarXLh = json_object_new_int64(b_i3 );
    //GEN_BUILTIN
    int32_t b_i4;
    memcpy(&b_i4, futag_pos, sizeof(int32_t));
    futag_pos += sizeof(int32_t);
    
    struct json_object * FutagRefVarCiF = json_object_new_int(b_i4 );
    //GEN_CSTRING
    ...
    struct json_object * FutagRefVar1go = json_object_new_string(str_s5 );
    //FREE
    if (rstr_s5) {
        free(rstr_s5);
        rstr_s5 = NULL;
    ...
    //FUNCTION_CALL
    json_object_object_add(body ,key7 ,FutagRefVarCWF );
    const char * key10 = "token";
    //FUNCTION_CALL
    json_object_object_add(body ,key10 ,FutagRefVarrUS );
    const char * key13 = "exchangeStart";
    //FUNCTION_CALL
    json_object_object_add(body ,key13 ,FutagRefVarcmL );
    const char * key16 = "exchangeEnd";
    //FUNCTION_CALL
    json_object_object_add(body ,key16 ,FutagRefVarXLh );
    const char * key19 = "exchangeResultCode";
    //FUNCTION_CALL
    json_object_object_add(body ,key19 ,FutagRefVarCiF );
    const char * key22 = "exchangeResultMessage";
    //FUNCTION_CALL
    json_object_object_add(body ,key22 ,FutagRefVar1go );
    //FUNCTION_CALL
...
// Compile command:
/* 
/home/russell/Futag/futag-llvm/bin/clang++ -fsanitize=address,fuzzer -g -O0 -ferror-limit=1 -I/home/russell/Futag-tests/json-c-contexts/json-c-json-c-0.16-20220414/ -I/home/russell/Futag-tests/json-c-contexts/json-c-json-c-0.16-20220414/.futag-build/ /home/russell/Futag-tests/json-c-contexts/json-c-json-c-0.16-20220414/futag-context-fuzz-drivers/succeeded/json_object_put/json_object_put.2/json_object_put.2.c -o /home/russell/Futag-tests/json-c-contexts/json-c-json-c-0.16-20220414/futag-context-fuzz-drivers/succeeded/json_object_put/json_object_put.2/json_object_put.2.out -Wl,--start-group /home/russell/Futag-tests/json-c-contexts/json-c-json-c-0.16-20220414/.futag-install/lib/libjson-c.a /home/russell/Futag-tests/json-c-contexts/json-c-json-c-0.16-20220414/.futag-build/libjson-c.a -Wl,--end-group 
 */
