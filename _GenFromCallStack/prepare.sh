...
if [ ! -f futag-llvm.2.0.4.tar.xz ]; then
    wget https://github.com/ispras/Futag/releases/download/2.0.1/futag-llvm.2.0.4.tar.xz
fi
...
echo "-- [Futag]: Установите Питон-пакет futag.2.0.4.tar.gz:"
echo "$ pip install /home/futag/Futag-tests/futag-llvm/python-package/futag-2.0.4.tar.gz"
echo ""
