...
int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    ...
    pos += dyn_size[0];
    const char * str_name = rstr_name;
    
    //GEN_BUILTIN
    uint32_t b_len;
    memcpy(&b_len, pos, sizeof(uint32_t));
    pos += sizeof(uint32_t);
    
    //FUNCTION_CALL
    stat_cache_delete_dir(str_name ,b_len );
    //FREE
    if (rstr_name) {
        free(rstr_name);
        rstr_name = NULL;
...
// Compile command:
/* 
/home/futag/Futag-tests/futag-llvm/bin/clang -fsanitize=address,fuzzer -g -O0 -ferror-limit=1 -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/../  /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/stat_cache_delete_dir/stat_cache_delete_dir1/stat_cache_delete_dir1.c -o /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/stat_cache_delete_dir/stat_cache_delete_dir1/stat_cache_delete_dir1.out 
 */

// Error log:
/* 
In file included from /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-fuzz-drivers/stat_cache_delete_dir/stat_cache_delete_dir1/stat_cache_delete_dir1.c:8:
