...
int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    ...
    //FUNCTION_CALL
    stat_cache_invalidate_entry(str_name ,b_len );
    //FREE
    if (rstr_name) {
        free(rstr_name);
        rstr_name = NULL;
...
// Compile command:
/* 
/home/futag/Futag-tests/futag-llvm/bin/clang -fsanitize=address,fuzzer -g -O0 -ferror-limit=1 -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/../  /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/stat_cache_invalidate_entry/stat_cache_invalidate_entry1/stat_cache_invalidate_entry1.c -o /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/stat_cache_invalidate_entry/stat_cache_invalidate_entry1/stat_cache_invalidate_entry1.out 
 */

// Error log:
/* 
In file included from /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-fuzz-drivers/stat_cache_invalidate_entry/stat_cache_invalidate_entry1/stat_cache_invalidate_entry1.c:8:
