...
int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    ...
    //GEN_BUILTIN
    int b_bits;
    memcpy(&b_bits, pos, sizeof(int));
    pos += sizeof(int);
    
    //FUNCTION_CALL
    sock_addr_is_addr_eq_bits(_a ,_b ,b_bits );
    //FREE
    return 0;
}
// Compile database: 
...
// Compile command:
/* 
/home/futag/Futag-tests/futag-llvm/bin/clang -fsanitize=address,fuzzer -g -O0 -ferror-limit=1 -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/../  /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/sock_addr_is_addr_eq_bits/sock_addr_is_addr_eq_bits1/sock_addr_is_addr_eq_bits1.c -o /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/sock_addr_is_addr_eq_bits/sock_addr_is_addr_eq_bits1/sock_addr_is_addr_eq_bits1.out 
 */

// Error log:
/* 
In file included from /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-fuzz-drivers/sock_addr_is_addr_eq_bits/sock_addr_is_addr_eq_bits1/sock_addr_is_addr_eq_bits1.c:8:
