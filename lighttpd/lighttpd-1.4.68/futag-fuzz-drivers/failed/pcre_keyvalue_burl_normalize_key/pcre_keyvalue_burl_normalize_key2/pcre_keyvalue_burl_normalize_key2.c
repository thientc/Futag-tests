...
int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    ...
    //GEN_VAR_FUNCTION
    buffer * s__k = chunk_buffer_acquire();
...
// Compile command:
/* 
/home/futag/Futag-tests/futag-llvm/bin/clang -fsanitize=address,fuzzer -g -O0 -ferror-limit=1 -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/../  /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/pcre_keyvalue_burl_normalize_key/pcre_keyvalue_burl_normalize_key2/pcre_keyvalue_burl_normalize_key2.c -o /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/pcre_keyvalue_burl_normalize_key/pcre_keyvalue_burl_normalize_key2/pcre_keyvalue_burl_normalize_key2.out 
 */

// Error log:
/* 
In file included from /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-fuzz-drivers/pcre_keyvalue_burl_normalize_key/pcre_keyvalue_burl_normalize_key2/pcre_keyvalue_burl_normalize_key2.c:11:
