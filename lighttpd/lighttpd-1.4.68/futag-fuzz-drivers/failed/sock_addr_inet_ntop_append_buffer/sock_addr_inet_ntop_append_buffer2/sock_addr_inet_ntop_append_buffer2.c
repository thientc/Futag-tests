...
int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    ...
    //FUNCTION_CALL
    sock_addr_inet_ntop_append_buffer(s__b ,_saddr );
    //FREE
    return 0;
}
// Compile database: 
...
// Compile command:
/* 
/home/futag/Futag-tests/futag-llvm/bin/clang -fsanitize=address,fuzzer -g -O0 -ferror-limit=1 -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/../  /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/sock_addr_inet_ntop_append_buffer/sock_addr_inet_ntop_append_buffer2/sock_addr_inet_ntop_append_buffer2.c -o /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/sock_addr_inet_ntop_append_buffer/sock_addr_inet_ntop_append_buffer2/sock_addr_inet_ntop_append_buffer2.out 
 */

// Error log:
/* 
In file included from /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-fuzz-drivers/sock_addr_inet_ntop_append_buffer/sock_addr_inet_ntop_append_buffer2/sock_addr_inet_ntop_append_buffer2.c:8:
