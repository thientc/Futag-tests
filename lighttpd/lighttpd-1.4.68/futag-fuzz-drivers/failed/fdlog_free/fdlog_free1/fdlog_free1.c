...
int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    ...
    //GEN_VAR_FUNCTION
    fdlog_st * s__fdlog = fdlog_init(str_1_fn,sz__1_fd,q_b__1_mode);
    //FUNCTION_CALL
    fdlog_free(s__fdlog );
    //FREE
    if (rstr_1_fn) {
...
// Compile command:
/* 
/home/futag/Futag-tests/futag-llvm/bin/clang -fsanitize=address,fuzzer -g -O0 -ferror-limit=1 -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/../  /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/fdlog_free/fdlog_free1/fdlog_free1.c -o /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/fdlog_free/fdlog_free1/fdlog_free1.out 
 */

// Error log:
/* 
/usr/bin/ld: /tmp/fdlog_free1-b053c4.o: in function `LLVMFuzzerTestOneInput':
fdlog_free1.c:(.text.LLVMFuzzerTestOneInput[LLVMFuzzerTestOneInput]+0x38c): undefined reference to `fdlog_init'
/usr/bin/ld: fdlog_free1.c:(.text.LLVMFuzzerTestOneInput[LLVMFuzzerTestOneInput]+0x39f): undefined reference to `fdlog_free'
