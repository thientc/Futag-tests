...
int LLVMFuzzerTestOneInput(uint8_t * Fuzz_Data, size_t Fuzz_Size){
    ...
    //FUNCTION_CALL
    li_tohex_lc(p_b__buf ,b_buf_len ,p_q_b__s ,b_s_len );
    //FREE
    return 0;
}
// Compile database: 
...
// Compile command:
/* 
/home/futag/Futag-tests/futag-llvm/bin/clang -fsanitize=address,fuzzer -g -O0 -ferror-limit=1 -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/src/ -I/home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/.futag-build/src/../  /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/li_tohex_lc/li_tohex_lc1/li_tohex_lc1.c -o /home/futag/Futag-tests/lighttpd/lighttpd-1.4.68/futag-fuzz-drivers/failed/li_tohex_lc/li_tohex_lc1/li_tohex_lc1.out 
 */

// Error log:
/* 
/usr/bin/ld: /tmp/li_tohex_lc1-04cada.o: in function `LLVMFuzzerTestOneInput':
li_tohex_lc1.c:(.text.LLVMFuzzerTestOneInput[LLVMFuzzerTestOneInput]+0x39b): undefined reference to `li_tohex_lc'
